"""
Django settings for b1withenglishpage project.
...
SECRET_KEY = 'django-insecure-xcem@%#6=i*iyjs^aix5(7cdc(#xjmd_b)2jo6(om$y*&&80k6'
...
WSGI_APPLICATION = 'b1withenglishpage.wsgi.application'
